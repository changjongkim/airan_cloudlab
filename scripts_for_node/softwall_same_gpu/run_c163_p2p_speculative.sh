...
label="c163_p2p_speculative_job${SLURM_JOB_ID}"
...
shifter_p2p python3 /softwall/c163_p2p_speculative_controller.py \
    ...
    --deadline-ms 4.5 --seed 20358000 >"$controller_log" 2>&1 &
controller_pid=$!
...
echo "C163 P2P speculative diagnostic complete: $controller_output"
