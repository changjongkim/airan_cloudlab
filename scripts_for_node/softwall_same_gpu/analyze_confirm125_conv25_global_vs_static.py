...
PROTOCOL = RES / "confirm125_conv25_global_vs_static_protocol.json"
...
def main() -> None:
    ...
    for seed in sorted(by_seed):
        ...
        ci = bootstrap_ci(delta, 125000 + seed)
    ...
    output = {
        "schema": "softwall-confirm125-conv25-global-vs-static-v1",
    ...
    out = RES / "confirm125_conv25_global_vs_static_result.json"
    ...
    if not output["structural_pass"]:
        raise SystemExit("Confirm125 structural gate failed")
