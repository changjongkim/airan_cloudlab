...
"""Gate one frozen C159-Q1 pre-staged P180 qualification run."""
...
def main() -> None:
    ...
    value = {
        "schema": "softwall-confirm159-q1-result-v1",
        "status": (
            "C159_Q1_PRESTAGED_P180_PASS" if all(gates.values())
            else "C159_Q1_PRESTAGED_P180_FAIL"
        ),
