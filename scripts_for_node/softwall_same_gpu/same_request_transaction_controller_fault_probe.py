...
def main() -> None:
    ...
    parser.add_argument("--inject-neural-failure-index", type=int, default=-1)
        ...
        for index in range(args.iterations):
            ...
            if admitted:
                ...
                try:
                    ...
                    if index == args.inject_neural_failure_index:
            ...
            if commit_kind != "nrx":
                ...
                if admitted:
                    ...
                    runtime.start_fallback(transaction, fallback_actual_start_ns)
    ...
    result = {
        ...
        "inject_neural_failure_index": args.inject_neural_failure_index,
