#!/usr/bin/env python3
"""Deterministic envelope checker with the complete AI admission guard.

Version 8 preserves the v7 finite-ring, home-local, control-budget, and
executor-phase checks.  It additionally charges the physical AI completion
guard separately from the radio commit guard and broker transaction budget.
"""
...
def main():
    ...
    output = {
        "schema": "softwall-deterministic-envelope-v8",
