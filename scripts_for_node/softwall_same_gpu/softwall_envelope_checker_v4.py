#!/usr/bin/env python3
"""Deterministic envelope checker with timed control-plane fault budgets."""
...
def evaluate(scenario):
    ...
    for bound in scenario["ai_bounds_ms"]:
        ...
        static_homes = [index for index, slack in enumerate(home_slack) if effective_bound <= slack]
        exchange_homes = [
...
def main():
    ...
    output = {
        "schema": "softwall-deterministic-envelope-v4",
