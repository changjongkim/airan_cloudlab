...
Compare a safety-checked AI-aware recovery retiming baseline with its fixed
counterpart, after both arms use the same asynchronous pre-NRx AI unit.
...
def main() -> None:
    ...
    parser.add_argument("--ai-aware-recovery", choices=("off", "on"), required=True)
    ...
    try:
        ...
        for index in range(args.iterations):
            ...
            if args.ai_aware_recovery == "on" and pending:
