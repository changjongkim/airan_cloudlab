...
Version 9 preserves the v8 timing, ring, and completion-fence checks while
...
do not consume the local recovery horizon.
"""
...
def main():
    ...
    output = {
        "schema": "softwall-deterministic-envelope-v9",
