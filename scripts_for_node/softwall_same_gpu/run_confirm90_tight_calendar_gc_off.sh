...
# Confirm90: conditional actual tight-calendar four-cell run with GC OFF.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm90_tight_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
cleanup
trap - EXIT INT TERM
echo "confirm90 tight-calendar GC-OFF run completed"
