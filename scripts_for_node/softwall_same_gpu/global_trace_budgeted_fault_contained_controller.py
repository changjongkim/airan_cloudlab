...
def composed_ai_guard_ns(base_guard_ns: int, broker_rpc_timeout_ms: float,
    ...
    """Reserve commit+complete RPC budgets around one physical AI unit."""
    broker_budget_ns = (
        2 * round(broker_rpc_timeout_ms * 1e6)
...
def main() -> None:
    ...
    result = {
        "schema": "softwall-global-trace-home-budgeted-fault-contained-v1",
        "system": args.system,
