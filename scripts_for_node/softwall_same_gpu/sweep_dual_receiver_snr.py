...
def main() -> None:
    ...
    parser.add_argument("--prewarm-observed-features", action="store_true")
    ...
    for _ in range(10):
        ...
        receiver.run_neural()
    if args.prewarm_observed_features:
        if not args.record_observed_features:
            parser.error("feature prewarm requires feature recording")
    ...
    document = {
        ...
        "observed_features_prewarmed": args.prewarm_observed_features,
        "seed": args.seed,
        "results": results,
    }
