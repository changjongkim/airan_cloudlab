#!/usr/bin/env python3
"""Three-cell / two-NeuralRx-endpoint bring-up with atomic AI lease.
...
def main() -> None:
    ...
    parser.add_argument("--cells", type=int, choices=(3,), default=3)
    ...
    result = {
        "schema": "softwall-three-cell-two-endpoint-v1",
    ...
    print(
        f"[THREE-CELL/TWO-ENDPOINT] correct={result['correct_cells']}/{len(records)} "
