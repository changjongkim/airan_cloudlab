...
def main() -> None:
    ...
    with cp.cuda.Device(args.destination_device):
        ...
        receiver = PairedDualReceiver(
            args.engine, seed=args.seed, device=args.destination_device
        )
    ...
    with cp.cuda.Device(args.destination_device):
        receiver._measure(receiver.neural_once_wrapper)
    ...
    try:
        ...
        result = {
            "schema": "softwall-c163-raw-p2p-nrx-worker-v3",
            "neural_execution_path": "single-stream pyAerial TensorRT wrapper",
            "host": platform.node(),
            "slurm_job_id": os.environ.get("SLURM_JOB_ID"),
            "source_device": args.source_device,
            "destination_device": args.destination_device,
            "peer_access": peer_access,
            "python_gc_enabled_during_epoch": gc.isenabled(),
