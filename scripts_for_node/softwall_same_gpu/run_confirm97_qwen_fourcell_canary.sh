...
# Confirm97: Qwen2.5-1.5B b1c16 prefill with four-cell NRx30/conv12 GC-OFF mode.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm97_qwen_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
cleanup
trap - EXIT INT TERM
echo "confirm97 Qwen four-cell GC-OFF canary completed"
