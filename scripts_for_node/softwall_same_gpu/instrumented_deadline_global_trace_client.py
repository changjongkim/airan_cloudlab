#!/usr/bin/env python3
"""Non-invasive RPC telemetry for the post-C136 SoftWall controller.

The C136 client and controller files remain unchanged so their frozen artifact
hashes stay reproducible.  This subclass records wall-clock duration around the
same fail-closed operations for the next qualification mode.
"""
...
class InstrumentedDeadlineGlobalTraceClient(DeadlineFaultContainedGlobalTraceClient):
    ...
    def rpc_telemetry(self):
        ...
        return {
            "schema": "softwall-broker-rpc-telemetry-v1",
            "timeout_ms": self.rpc_timeout_ms,
            "records": list(self.rpc_records),
