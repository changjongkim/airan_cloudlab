...
# Confirm95: actual AI8 host budget with four-cell NRx30/conv12 GC-OFF mode.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm95_ai8_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
shifter_gpu env CUDA_MPS_CLIENT_PRIORITY=0 \
    ...
    --endpoint-timeout-ms 100 --ai-budget-ms 8 --ai-guard-ms 2 \
...
cleanup
trap - EXIT INT TERM
echo "confirm95 AI8 four-cell GC-OFF run completed"
