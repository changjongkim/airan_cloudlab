...
label=${SOFTWALL_SHARD_LABEL:-global_ai_low_perturbation_broker_crash_job${SLURM_JOB_ID}}
...
cleanup
trap - EXIT INT TERM
echo "global AI low-perturbation broker crash arm complete: $result"
