...
build_log="$SOFTWALL_ROOT/runtime/softwall_same_gpu/engines/neural_rx_fp32_reference_python.build.log"
output="$SOFTWALL_ROOT/results/softwall_same_gpu/raw/aerial_tdl_fp32_reference_development_v2_job${SLURM_JOB_ID}.json"
...
shifter_gpu env CUDA_MPS_CLIENT_PRIORITY=0 \
    ...
    --engine /softwall_runtime/engines/neural_rx_fp32_reference.trt \
    --output "$output" \
    --iterations 10 --payload-seed 20357600 --tdl-seed 57601
