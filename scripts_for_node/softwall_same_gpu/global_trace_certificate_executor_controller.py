...
def main() -> None:
        ...
        for index in range(args.iterations):
            ...
            if any(tx.reservation is not None for tx in transactions):
                ...
                if async_ai_request is not None:
                    ...
                    commit_selected(trace_queue, async_ai_request)
                    def run_pre_radio():
    ...
    result = {
        "schema": "softwall-global-trace-home-v1",
        "system": args.system,
