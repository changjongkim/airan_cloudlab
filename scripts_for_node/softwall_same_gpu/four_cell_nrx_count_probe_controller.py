#!/usr/bin/env python3
"""Controlled one-versus-two NeuralRx co-run probe with atomic AI lease.
...
def main() -> None:
    ...
    parser.add_argument("--max-nrx-admissions", type=int, choices=(1, 2), required=True)
    ...
    try:
        ...
        for index in range(args.iterations):
            ...
            for cell in admission_order:
                ...
                if row["gate_skipped"]:
                    continue
                if admitted_count >= args.max_nrx_admissions:
