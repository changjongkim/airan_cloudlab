...
Version 11 preserves the v8 timing, ring, and completion-fence checks while
...
single-token ownership qualification and, when declared, physical coverage of all four state-changing broker operations.
"""
...
def evaluate(scenario):
    ...
    four_point_required = scenario.get(
        "four_point_control_fault_required", False
    )
    four_point_qualified = scenario.get(
        "four_point_control_fault_qualified", not four_point_required
    )
    ...
    elif four_point_required and not four_point_qualified:
        status = "UQ"
        reason = "declared broker fault class lacks physical coverage of all four state-changing operations"
    ...
    return {
        ...
        "four_point_control_fault_required": four_point_required,
...
def main():
    ...
    output = {
        "schema": "softwall-deterministic-envelope-v11",
