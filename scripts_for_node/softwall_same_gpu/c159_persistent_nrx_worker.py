#!/usr/bin/env python3
"""Persistent four-peer TensorRT NeuralRx worker for C159 P180 qualification."""
...
from actual_nrx_multi_peer_worker import load_spec, wait_json
...
def main() -> None:
    ...
    try:
        ...
        result = {
            "schema": "softwall-c159-persistent-nrx-worker-v1",
            "host": platform.node(),
            "slurm_job_id": os.environ.get("SLURM_JOB_ID"),
            "destination_device": args.destination_device,
            "iterations": args.iterations,
            "peer_count": len(specs),
            "lifecycle": "startup preflight only; no per-epoch activation",
            "peer_access": access,
