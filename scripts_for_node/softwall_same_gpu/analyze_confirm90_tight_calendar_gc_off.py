...
"""Audit actual tighter four-cell calendar under GC-OFF mode."""
...
def main() -> None:
    ...
    report = {
        "schema": "softwall-confirm90-actual-tight-calendar-gc-off-v1",
    ...
    output = base / f"confirm90_tight_calendar_gc_off_job{protocol['job']}.json"
