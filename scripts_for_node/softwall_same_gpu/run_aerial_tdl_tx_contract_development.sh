...
output="$SOFTWALL_ROOT/results/softwall_same_gpu/raw/aerial_tdl_tx_contract_development_job${SLURM_JOB_ID}.json"
shifter_gpu env CUDA_MPS_CLIENT_PRIORITY=0 \
    ...
    --output "$output" \
    --iterations 10 --payload-seed 20357400 --tdl-seed 57401
