...
from c163_raw_p2p_nrx_worker_v3 import BACKWARD_ELEMENTS, FWD_ELEMENTS, SLOT_ELEMENTS, SLOT_SHAPE
...
def main() -> None:
    ...
    result = {
        "schema": "softwall-c163-raw-p2p-controller-v3",
        "neural_execution_path": "single-stream pyAerial TensorRT wrapper on GPU1",
        "analysis_role": (
