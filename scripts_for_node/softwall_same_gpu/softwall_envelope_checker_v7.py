#!/usr/bin/env python3
"""Deterministic envelope checker with physical endpoint-credit limits.

Version 7 preserves the v6 home-local, control-budget, and decision-time checks,
caps synchronous endpoint admission by physical ring depth, and treats whether
rejected mandatory recoveries run before the exchange as an executor-mode axis.
"""
...
def evaluate(scenario):
    ...
    return {
        ...
        "home_endpoint_ring_depths": scenario.get(
            "home_endpoint_ring_depths"
        ),
        "rejected_recovery_before_exchange": rejected_first,
...
def main():
    ...
    output = {
        "schema": "softwall-deterministic-envelope-v7",
