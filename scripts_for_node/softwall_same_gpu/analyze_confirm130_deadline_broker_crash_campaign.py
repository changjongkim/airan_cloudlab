#!/usr/bin/env python3
"""Aggregate prospective C130 deadline-bounded broker fail-stop arms."""
...
def main() -> None:
    ...
    value = {
        "schema": "softwall-confirm130-deadline-broker-crash-campaign-v1",
        ...
        "claim": (
            "With a 5 ms broker-RPC budget and no synchronous fault-path logging, after a broker fail-stop "
    ...
    if not value["all_pass"]:
        raise SystemExit("C130 campaign gate failed")
