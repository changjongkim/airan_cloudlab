...
RAW = RESULTS / "raw"
PROTOCOL = RESULTS / "confirm113_strong_baselines_protocol.json"
...
def main() -> None:
    ...
    comparisons = [
        compare_pair(pair, arms, trace, 113_000 + index)
    ...
    result = {
        "schema": "softwall-confirm113-strong-baselines-v1",
    ...
    output = RESULTS / f"confirm113_strong_baselines_job{protocol['job']}.json"
