...
# Confirm80: four-cell all-fail and 15 ms atomic AI lease physical canary.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm80_fourcell_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
cleanup
trap - EXIT INT TERM
echo "confirm80 AI-15 four-cell run completed"
