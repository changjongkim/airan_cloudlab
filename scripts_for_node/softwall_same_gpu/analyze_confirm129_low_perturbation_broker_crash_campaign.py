#!/usr/bin/env python3
"""Aggregate prospective C129 low-perturbation broker fail-stop arms."""
...
def main() -> None:
    ...
    value = {
        "schema": "softwall-confirm129-low-perturbation-broker-crash-campaign-v1",
        ...
        "claim": (
            "With no synchronous fault-path logging, after a broker fail-stop "
    ...
    if not value["all_pass"]:
        raise SystemExit("C129 campaign gate failed")
