...
# Confirm85: instrument four-cell NRx admission and preparation around release 620.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm85_tailprobe_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
shifter_gpu env CUDA_MPS_CLIENT_PRIORITY=0 \
    python3 /softwall/four_cell_tail_probe_controller.py \
...
cleanup
trap - EXIT INT TERM
echo "confirm85 four-cell tail-probe run completed"
