...
# Confirm61: early conventional / other-cell NeuralRx co-run diagnostic arm.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm61_${mode}_job${SLURM_JOB_ID}}
...
cleanup
trap - EXIT INT TERM
echo "confirm61 mode=$mode completed"
