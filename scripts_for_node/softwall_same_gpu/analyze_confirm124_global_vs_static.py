#!/usr/bin/env python3
"""Audit ABBA global-broker versus static-partition multi-home arms."""
...
PROTOCOL = RES / "confirm124_global_vs_static_protocol.json"
...
def main() -> None:
    ...
    for seed in sorted(by_seed):
        ...
        ci = bootstrap_ci(delta, 124000 + seed)
        comparisons.append({
            "seed": seed,
            ...
            "outcome_pass": effect_pct >= 2.0 and ci[0] > 0,
        })
    structural_gates = {
    ...
    output = {
        "schema": "softwall-confirm124-global-vs-static-v1",
    ...
    out = RES / "confirm124_global_vs_static_result.json"
    ...
    if not output["structural_pass"]:
        raise SystemExit("Confirm124 structural gate failed")
