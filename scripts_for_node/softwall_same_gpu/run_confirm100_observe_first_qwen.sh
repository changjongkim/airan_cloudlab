...
# Confirm100: observe NeuralRx before early mandatory conventional work.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm100_observe_first_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
shifter_gpu env CUDA_MPS_CLIENT_PRIORITY=0 \
    python3 /softwall/four_cell_observe_first_controller.py \
...
cleanup
trap - EXIT INT TERM
echo "confirm100 observe-first Qwen four-cell GC-OFF run completed"
