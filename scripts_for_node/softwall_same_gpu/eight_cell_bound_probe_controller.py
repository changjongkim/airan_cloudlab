...
def main() -> None:
    ...
    parser.add_argument("--cells", type=int, choices=(8,), default=8)
    ...
    result = {
        "schema": "softwall-eight-cell-two-endpoint-v1",
    ...
    print(
        f"[EIGHT-CELL/TWO-ENDPOINT] correct={result['correct_cells']}/{len(records)} "
