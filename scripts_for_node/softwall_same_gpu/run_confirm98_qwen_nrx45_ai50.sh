...
# Confirm98: Qwen b1c16 prefill with actual four-cell NRx45/conv12/AI50 mode.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm98_qwen_nrx45_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
shifter_gpu env CUDA_MPS_CLIENT_PRIORITY=0 \
    python3 /softwall/four_cell_gc_intervention_controller.py \
...
cleanup
trap - EXIT INT TERM
echo "confirm98 Qwen NRx45 AI50 four-cell GC-OFF run completed"
