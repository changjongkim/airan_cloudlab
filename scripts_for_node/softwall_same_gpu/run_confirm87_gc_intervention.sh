...
# Confirm87: paired Python cyclic-GC ON/OFF intervention in four-cell mode.
...
prefix=${SOFTWALL_GATE_PREFIX:-confirm87_gc${SOFTWALL_GC_MODE}_seed${channel_seed_base}_job${SLURM_JOB_ID}}
...
cleanup
trap - EXIT INT TERM
echo "confirm87 four-cell GC intervention run completed"
